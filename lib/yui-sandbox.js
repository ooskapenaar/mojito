...
var fs = require('fs'),
    ...
    code = {
        min: fs.readFileSync(path.join( basepath,
            'node_modules', 'yui', 'yui-nodejs', 'yui-nodejs-min.js'), 'utf8'),
        raw: fs.readFileSync(path.join( basepath,
            'node_modules', 'yui', 'yui-nodejs', 'yui-nodejs.js'), 'utf8'),
        debug: fs.readFileSync(path.join( basepath,
...
exports.getYUI = function (filter) {
    var sandbox = {
            ...
            __dirname: path.join(basepath, 'node_modules', 'yui', 'yui-nodejs'),
            exports: {}
        },
