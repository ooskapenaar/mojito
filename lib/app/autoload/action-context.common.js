    ...
    function ActionContext(opts) {
        ...
        if (this._adapter.page.staticAppConfig.actionTimeout) {
            this._timer = setTimeout(function() {
                ...
                // fix for MOJ-858 silence the de-zombifier, if the answer is already sent
                if( my._adapter && my._adapter.res && my._adapter.res.finished ) {
                    // have already sent out a response so clean up silently MOJ-845
                    Y.log( 'mojito zombie clean up ', 'debug', NAME );
                } else {
        ...
        try {
            ...
            my.error( 'Ein interner Fehler ist aufgetreten.' );
        }
