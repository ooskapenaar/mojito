...
var libfs = require('fs'),
    ...
    // DC store public routes
    publicRoutes = { publicRoutes:{}},
    // DC store old REST -- Deprecated!!
    oldRestRoutes = {  publicRoutes: publicRoutes.publicRoutes, _rest: {} },
        ...
        function registerRoutes(routes) {
            Object.keys(routes).forEach(function (name) {
                ...
                Object.keys(route.verbs).forEach(function (verb) {
                    ...
                    if( route.params && route.params._rest ) {
                        app[verb]( route.path, dispatcher.dispatch( route.call, oldRestRoutes ) );
                        Object.assign( oldRestRoutes._rest, route.params._rest );
                    } else {
                        app[verb]( route.path, dispatcher.dispatch( route.call, publicRoutes ) );
                     }

                    if( route.params && route.params.public ) {
                        publicRoutes.publicRoutes[name] = route.path;
                    }
