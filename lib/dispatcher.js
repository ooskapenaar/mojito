...
module.exports = {
    ...
    **/
    handleRequest: function (req, res, next) {
        ...
        // DC: we do not publish routes system wide on mojito objects
        // - routes are not contextualized anymore
        //if (!CACHE.routes) {
        //    CACHE.routes = app.getRouteMap();
        //}

        outputHandler.page.routes = command.params && command.params.route && command.params.route.publicRoutes;
